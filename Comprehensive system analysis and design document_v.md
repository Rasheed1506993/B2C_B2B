...
# style: shape=rectangle;whiteSpace=wrap;html=1;rounded=1;fillColor=%fill%;strokeColor=%stroke%;fontSize=12;align=center;
# parent: -
# width: 200
# height: auto
# layout: verticaltree
...
Component,Description,fill,stroke,parent
الشاشة الرئيسية,Container الأساسي,#f5f5f5,#cccccc,
الترويسة,شعار + قائمة + إشعارات,#ffffff,#e0e0e0,الشاشة الرئيسية
بطاقة الترحيب,ترحيب بالمستخدم,#fff8e1,#ffb300,الشاشة الرئيسية
عارض السيارات,Carousel للسيارات,#ffffff,#e0e0e0,الشاشة الرئيسية
بطاقة سيارة 1,صورة + تفاصيل + زر,#ffffff,#e0e0e0,عارض السيارات
بطاقة سيارة 2,صورة + تفاصيل + زر,#ffffff,#e0e0e0,عارض السيارات
بطاقة سيارة 3,صورة + تفاصيل + زر,#ffffff,#e0e0e0,عارض السيارات
مؤشر الموقع,نقاط توضيحية,#e0e0e0,#cccccc,الشاشة الرئيسية
قائمة الخدمات السريعة,أيقونات الوصول السريع,#ffffff,#e0e0e0,الشاشة الرئيسية
التذييل,روابط + معلومات,#ffffff,#e0e0e0,الشاشة الرئيسية
```
...
```
## مكونات شاشة الحجز
# style: shape=rectangle;whiteSpace=wrap;html=1;rounded=1;fillColor=%fill%;strokeColor=%stroke%;fontSize=11;
# width: 180
# height: auto
# layout: verticaltree
# levelspacing: 25

Section,Component,fill,stroke,parent
رأس الصفحة,صورة السيارة + الاسم,#ffffff,#e0e0e0,
مؤشر التقدم,خطوات الحجز 1-4,#fff8e1,#ffb300,
قسم المنطقة,اختيار المنطقة,#ffffff,#e0e0e0,
قسم الخدمة,بطاقات أنواع الخدمات,#ffffff,#e0e0e0,قسم الخدمة
توصيل,أيقونة + وصف,#e3f2fd,#1976d2,قسم الخدمة
بالساعة,أيقونة + وصف,#e8f5e9,#388e3c,قسم الخدمة
جولة 8 ساعات,أيقونة + وصف,#fff3e0,#f57c00,قسم الخدمة
يوم كامل,أيقونة + وصف,#f3e5f5,#7b1fa2,قسم الخدمة
قسم التفاصيل,حقول إدخال البيانات,#ffffff,#e0e0e0,
موقع الانطلاق,حقل + أيقونة GPS,#fafafa,#bdbdbd,قسم التفاصيل
الوجهة,حقل + أيقونة بحث,#fafafa,#bdbdbd,قسم التفاصيل
الخريطة,خريطة تفاعلية صغيرة,#e0f2f1,#00897b,قسم التفاصيل
التاريخ والوقت,منتقي تاريخ ووقت,#fafafa,#bdbdbd,قسم التفاصيل
قسم الراكب,معلومات الراكب,#ffffff,#e0e0e0,
حساب السعر,عرض السعر التفصيلي,#fff8e1,#ffa000,
أزرار التحكم,إضافة للسلة + احجز الآن,#ff9800,#e65100,
```
...
```
## هيكل شاشة السلة
# style: shape=rectangle;whiteSpace=wrap;html=1;rounded=1;fillColor=%fill%;strokeColor=%stroke%;
# width: 190
# height: auto
# layout: verticaltree

Element,Details,fill,stroke
رأس السلة,رقم الحجز العام + عدد الخدمات,#ffffff,#e0e0e0
قائمة الخدمات,Container للبطاقات,#f5f5f5,#cccccc
بطاقة خدمة 1,تفاصيل موجزة + أزرار,#ffffff,#e0e0e0
بطاقة خدمة 2,تفاصيل موجزة + أزرار,#ffffff,#e0e0e0
بطاقة خدمة 3,تفاصيل موجزة + أزرار,#ffffff,#e0e0e0
ملخص مالي,تفصيل الأسعار,#fff8e1,#ffa000
المجموع الفرعي,قيمة جميع الخدمات,#fafafa,#bdbdbd
الخصومات,قيمة الخصم إن وجد,#e8f5e9,#66bb6a
ضريبة القيمة المضافة,15% من المجموع,#fafafa,#bdbdbd
المبلغ الإجمالي,المبلغ النهائي المطلوب,#ffecb3,#ff6f00
زر متابعة للدفع,انتقال لشاشة الدفع,#ff9800,#e65100
زر إضافة خدمة جديدة,العودة لشاشة الحجز,#e0e0e0,#9e9e9e
```
...
Component,Description,fill,stroke
رأس صفحة الدفع,المبلغ الإجمالي بارز,#ffffff,#e0e0e0
ملخص الحجز,رقم الحجز + التفاصيل,#e3f2fd,#1976d2
طرق الدفع,عنوان القسم,#fafafa,#bdbdbd
بطاقة الدفع نقداً,أيقونة + وصف,#ffffff,#e0e0e0
بطاقة مدى/فيزا,أيقونة + وصف + شعارات,#ffffff,#e0e0e0
بطاقة تحويل بنكي,أيقونة + وصف,#ffffff,#e0e0e0
بطاقة دفع آجل,أيقونة + وصف + شرط,#fff3e0,#f57c00
تفاصيل الطريقة المختارة,حقول إضافية حسب الطريقة,#f5f5f5,#cccccc
معلومات الأمان,أيقونة قفل + نص طمأنة,#e8f5e9,#66bb6a
سياسة الإلغاء,رابط لشروط الإلغاء,#fafafa,#bdbdbd
زر تأكيد الدفع,إتمام العملية,#4caf50,#2e7d32
زر العودة,الرجوع للسلة,#e0e0e0,#9e9e9e
```
...
Section,Component,fill,stroke
بطاقة الحالة,حالة الحجز + رقم الحجز,#c8e6c9,#66bb6a
معلومات أساسية,تاريخ + عدد الخدمات + المبلغ,#ffffff,#e0e0e0
قائمة الخدمات,بطاقات الخدمات الفردية,#f5f5f5,#cccccc
خدمة 1,تفاصيل كاملة,#ffffff,#e0e0e0
خدمة 2,تفاصيل كاملة,#ffffff,#e0e0e0
معلومات السائق,الاسم + الصورة + الجوال + السيارة,#fff8e1,#ffa000
صورة السائق,صورة شخصية دائرية,#fafafa,#bdbdbd
معلومات السيارة,الماركة + الموديل + اللون + اللوحة,#ffffff,#e0e0e0
أزرار التواصل,اتصال + واتساب,#e3f2fd,#1976d2
تتبع الرحلة,خريطة حية للموقع,#e0f2f1,#00897b
معلومات الدفع,الطريقة + الحالة + الإيصال,#ffffff,#e0e0e0
أزرار الإجراءات,تعديل + إلغاء + مشاركة,#e0e0e0,#9e9e9e
قسم التقييم,تقييم الخدمة بعد الإتمام,#fff3e0,#ff6f00
```
...
```
## مراحل تسجيل المورد
# style: shape=rectangle;whiteSpace=wrap;html=1;rounded=1;fillColor=%fill%;strokeColor=%stroke%;fontSize=10;
# width: 180
# height: auto
# layout: horizontaltree
# levelspacing: 40

Stage,Components,fill,stroke
المرحلة 1: البيانات الشخصية,حقول + مستندات + بنك,#e3f2fd,#1976d2
حقول شخصية,الاسم + الجوال + البريد + الهوية,#ffffff,#e0e0e0
رفع المستندات,صورة الهوية + الرخصة,#fff8e1,#ffa000
معلومات البنك,البنك + الحساب + الآيبان,#ffffff,#e0e0e0
المرحلة 2: معلومات السيارة,بيانات + مستندات + صور,#e8f5e9,#66bb6a
بيانات السيارة,اللوحة + الماركة + الموديل + السنة,#ffffff,#e0e0e0
مستندات السيارة,الاستمارة + التأمين,#fff8e1,#ffa000
صور السيارة,4 خارجية + 4 داخلية,#fff3e0,#ff6f00
المرحلة 3: المراجعة,ملخص + موافقة + إرسال,#f3e5f5,#7b1fa2
ملخص البيانات,عرض جميع المعلومات,#ffffff,#e0e0e0
شروط الخدمة,موافقة على الشروط,#fafafa,#bdbdbd
زر الإرسال,إرسال للمراجعة,#4caf50,#2e7d32
```
...
Section,Description,fill,stroke
الترويسة,الاسم + الصورة + الحالة,#ffffff,#e0e0e0
بطاقات الإحصائيات,4 بطاقات سريعة,#e3f2fd,#1976d2
رحلات اليوم,العدد,#ffffff,#64b5f6
رحلات الشهر,العدد,#ffffff,#64b5f6
أرباح اليوم,المبلغ بالريال,#c8e6c9,#66bb6a
أرباح الشهر,المبلغ بالريال,#c8e6c9,#66bb6a
الحجوزات الواردة,قائمة الحجوزات الجديدة,#fff8e1,#ffa000
الحجوزات النشطة,الرحلات الجارية,#e8f5e9,#66bb6a
كشف الحساب,ملخص مالي سريع,#f3e5f5,#7b1fa2
التقييم العام,متوسط التقييمات,#fff3e0,#ff6f00
القائمة السفلية,تنقل بين الأقسام,#ffffff,#e0e0e0
```
...
Tab,Content,fill,stroke
الحجوزات الواردة,قائمة الحجوزات الجديدة,#fff8e1,#ffa000
بطاقة حجز 1,معلومات + أزرار,#ffffff,#e0e0e0
بطاقة حجز 2,معلومات + أزرار,#ffffff,#e0e0e0
الحجوزات النشطة,قائمة المقبولة,#e8f5e9,#66bb6a
حجز قادم,تفاصيل + وقت متبقي,#e3f2fd,#1976d2
حجز جاري,تفاصيل + زر إنهاء,#c8e6c9,#388e3c
الحجوزات المكتملة,سجل الرحلات السابقة,#f5f5f5,#bdbdbd
حجز مكتمل 1,ملخص + تاريخ,#fafafa,#e0e0e0
حجز مكتمل 2,ملخص + تاريخ,#fafafa,#e0e0e0
فلترة وبحث,أدوات تصفية,#e0e0e0,#9e9e9e
```
...
Component,Details,fill,stroke
الملخص المالي,الرصيد + المدفوعات + العدد,#f3e5f5,#7b1fa2
الدفعة القادمة,التاريخ + المبلغ + شريط تقدم,#fff8e1,#ffa000
سجل المعاملات,قائمة زمنية,#ffffff,#e0e0e0
معاملة عمولة 1,تاريخ + مبلغ + رصيد,#e8f5e9,#66bb6a
معاملة دفعة 1,تاريخ + مبلغ + رصيد,#e3f2fd,#1976d2
معاملة تسوية,تاريخ + مبلغ + رصيد,#fff3e0,#ff6f00
فلترة السجل,حسب النوع + التاريخ,#e0e0e0,#9e9e9e
تحميل التقرير,تصدير PDF أو Excel,#fafafa,#bdbdbd
```
...
Section,Description,fill,stroke
شريط الملاحة,شعار + روابط + تسجيل دخول,#ffffff,#e0e0e0
القسم البطل,صورة كبيرة + عنوان + زر CTA,#1a237e,#0d47a1
العنوان الرئيسي,نص كبير جذاب,#ffffff,#1a237e
العنوان الفرعي,وصف مختصر للخدمة,#e0e0e0,#1a237e
زر احجز الآن,CTA بارز,#ff9800,#e65100
قسم المميزات,4-6 بطاقات مميزات,#f5f5f5,#cccccc
ميزة 1,أيقونة + عنوان + وصف,#ffffff,#e0e0e0
ميزة 2,أيقونة + عنوان + وصف,#ffffff,#e0e0e0
ميزة 3,أيقونة + عنوان + وصف,#ffffff,#e0e0e0
قسم السيارات,عرض الفئات,#ffffff,#e0e0e0
بطاقة سيدان,صورة + وصف + سعر ابتدائي,#ffffff,#e0e0e0
بطاقة SUV,صورة + وصف + سعر ابتدائي,#ffffff,#e0e0e0
بطاقة لاكجري,صورة + وصف + سعر ابتدائي,#ffffff,#e0e0e0
قسم الشركاء,معلومات B2B,#e3f2fd,#1976d2
قسم الشهادات,آراء العملاء,#f5f5f5,#cccccc
التذييل,روابط + تواصل + حقوق,#263238,#000000
```
...
Section,Component,fill,stroke
الرأس,عنوان + وصف,#ffffff,#e0e0e0
شريط التصفية,اختيار المنطقة,#fff8e1,#ffa000
قسم السيدان,بطاقة الفئة + جدول أسعار,#ffffff,#e0e0e0
صورة السيارة,صورة عالية الجودة,#fafafa,#bdbdbd
معلومات الفئة,الوصف + المميزات,#ffffff,#e0e0e0
جدول الأسعار,الخدمات + الأسعار,#f5f5f5,#cccccc
سعر التوصيل,ريال لكل كيلومتر,#e8f5e9,#66bb6a
سعر بالساعة,سعر ثابت للساعة,#e8f5e9,#66bb6a
سعر 8 ساعات,جولة سياحية,#e8f5e9,#66bb6a
سعر 12 ساعة,يوم كامل,#e8f5e9,#66bb6a
ساعة زائدة,بعد انتهاء الخدمة,#e8f5e9,#66bb6a
زر احجز الآن,انتقال للحجز,#ff9800,#e65100
قسم SUV,بطاقة الفئة + جدول أسعار,#ffffff,#e0e0e0
قسم الباص,بطاقة الفئة + جدول أسعار,#ffffff,#e0e0e0
قسم اللاكجري,بطاقة الفئة + جدول أسعار,#ffffff,#e0e0e0
ملاحظات الأسعار,شروح إضافية,#fff3e0,#f57c00
```
...
Column,Section,Component,fill,stroke
عمود النموذج,رأس الصفحة,عنوان + مؤشر التقدم,#ffffff,#e0e0e0
عمود النموذج,اختيار المنطقة,قائمة منسدلة,#fafafa,#bdbdbd
عمود النموذج,اختيار الخدمة,بطاقات أفقية,#ffffff,#e0e0e0
عمود النموذج,تفاصيل الموقع,حقول + خريطة,#e0f2f1,#00897b
عمود النموذج,التاريخ والوقت,منتقيات تقويمية,#fafafa,#bdbdbd
عمود النموذج,معلومات الراكب,حقول نصية,#fafafa,#bdbdbd
عمود النموذج,أزرار التحكم,التالي + السابق,#ff9800,#e65100
عمود الملخص,بطاقة الملخص,ملخص حي للحجز,#fff8e1,#ffa000
عمود الملخص,تفاصيل الخدمة,نوع + تاريخ + وقت,#ffffff,#e0e0e0
عمود الملخص,معلومات المسار,من + إلى + مسافة,#e3f2fd,#1976d2
عمود الملخص,تفصيل الأسعار,سعر أساسي + إضافات,#e8f5e9,#66bb6a
عمود الملخص,السعر الإجمالي,المبلغ النهائي,#ffecb3,#ff6f00
عمود الملخص,ملاحظات,معلومات إضافية,#fafafa,#bdbdbd
```
...
```
## بنية Dashboard الرئيسي
# style: shape=rectangle;whiteSpace=wrap;html=1;rounded=1;fillColor=%fill%;strokeColor=%stroke%;fontSize=9;
# width: 180
# layout: verticaltree
# levelspacing: 20

Section,Component,fill,stroke
الترويسة العليا,اسم القسم + بحث + إشعارات + مستخدم,#ffffff,#e0e0e0
بطاقات الإحصائيات السريعة,4 بطاقات أفقية,#f5f5f5,#cccccc
إجمالي الحجوزات اليوم,عدد + نسبة تغيير,#e3f2fd,#1976d2
الإيرادات اليوم,مبلغ + نسبة تغيير,#c8e6c9,#388e3c
الحجوزات المعلقة,عدد + رابط سريع,#fff3e0,#f57c00
العملاء النشطين,عدد + نسبة تغيير,#f3e5f5,#7b1fa2
الرسوم البيانية,صفان من الرسوم,#ffffff,#e0e0e0
رسم الإيرادات,آخر 7 أيام,#e8f5e9,#66bb6a
رسم الحجوزات,توزيع حسب الحالة,#e3f2fd,#1976d2
رسم السيارات,توزيع حسب الفئة,#fff3e0,#ff6f00
رسم المناطق,توزيع جغرافي,#f3e5f5,#9c27b0
الحجوزات الأخيرة,جدول مختصر,#ffffff,#e0e0e0
التنبيهات,إشعارات مهمة,#ffebee,#e53935
الإجراءات السريعة,أزرار مختصرة,#e0e0e0,#9e9e9e
```
...
Component,Description,fill,stroke
الرأس,عنوان + عداد الحجوزات المعلقة,#fff8e1,#ffa000
شريط التصفية,فلاتر متعددة + بحث,#fafafa,#bdbdbd
الجدول الرئيسي,قائمة الحجوزات,#ffffff,#e0e0e0
عمود رقم الحجز,قابل للنقر,#e3f2fd,#1976d2
عمود العميل,الاسم + النوع,#ffffff,#e0e0e0
عمود التاريخ والوقت,منسق بوضوح,#ffffff,#e0e0e0
عمود الخدمة,النوع + المنطقة,#ffffff,#e0e0e0
عمود المبلغ,بالريال,#e8f5e9,#66bb6a
عمود حالة الدفع,مدفوع/معلق/كاش,#fff3e0,#ff9800
عمود الإجراءات,أزرار موافقة ورفض,#fafafa,#bdbdbd
زر موافقة,تأكيد الحجز,#4caf50,#2e7d32
زر رفض,رفض الحجز,#f44336,#c62828
زر تفاصيل,عرض كامل,#2196f3,#1565c0
نافذة التفاصيل,Modal بالمعلومات الكاملة,#ffffff,#e0e0e0
معلومات العميل,كاملة ومفصلة,#e3f2fd,#1976d2
تفاصيل الخدمة,الخدمات المطلوبة,#e8f5e9,#66bb6a
معلومات الدفع,الطريقة + الحالة,#fff8e1,#ffa000
أزرار الإجراء النهائية,موافقة/رفض نهائي,#f5f5f5,#cccccc
```
...
Section,Component,fill,stroke
الرأس,عنوان + عداد + تحديث تلقائي,#fff3e0,#ff6f00
الفلاتر المتقدمة,وقت + منطقة + فئة + بحث,#fafafa,#bdbdbd
الجدول الرئيسي,حجوزات قيد التجهيز,#ffffff,#e0e0e0
عمود الحجز,رقم + حالة,#e3f2fd,#1976d2
عمود العميل,اسم + جوال,#ffffff,#e0e0e0
عمود الخدمة,نوع + موقع + وجهة,#ffffff,#e0e0e0
عمود الوقت,تاريخ + عداد تنازلي,#fff3e0,#ff6f00
عمود الفئة المطلوبة,نوع السيارة,#ffffff,#e0e0e0
عمود السيارات المتاحة,عدد + رابط,#e8f5e9,#66bb6a
عمود الإجراء,زر ربط مع سائق,#ff9800,#e65100
نافذة اختيار السائق,Modal للسيارات المتاحة,#ffffff,#e0e0e0
قائمة السيارات,سيارات الفئة المتاحة,#f5f5f5,#cccccc
بطاقة سيارة/سائق,معلومات كاملة,#ffffff,#e0e0e0
صورة السائق,دائرية,#e3f2fd,#1976d2
معلومات السائق,اسم + جوال + تقييم,#ffffff,#e0e0e0
معلومات السيارة,ماركة + موديل + لوحة,#ffffff,#e0e0e0
حالة التوفر,متاح/مشغول/صيانة,#e8f5e9,#66bb6a
زر التحديد,ربط هذا السائق,#4caf50,#2e7d32
تأكيد الربط,نافذة تأكيد نهائية,#fff8e1,#ffa000
إرسال الإشعارات,SMS + WhatsApp تلقائي,#e8f5e9,#66bb6a
```
...
Section,Component,fill,stroke
رأس النافذة,رقم الحجز + حالة الإقفال,#1a237e,#0d47a1
ملخص الحجز,معلومات أساسية,#e3f2fd,#1976d2
العميل والسائق,بيانات الأطراف,#ffffff,#e0e0e0
تفاصيل الخدمات,جدول الخدمات المنفذة,#ffffff,#e0e0e0
قسم التحقق من الدفع,مراجعة حالة الدفع,#fff8e1,#ffa000
حالة الدفع,مؤكد/معلق/كاش,#e8f5e9,#66bb6a
طريقة الدفع,نقد/بطاقة/تحويل/كريديت,#ffffff,#e0e0e0
إثبات الدفع,عرض/رفع المستند,#fafafa,#bdbdbd
قسم الخصومات,تطبيق الخصومات,#e8f5e9,#66bb6a
خصم العميل,نسبة مئوية,#ffffff,#e0e0e0
خصم الشركة,نسبة مئوية,#ffffff,#e0e0e0
خصومات خاصة,قيمة ثابتة,#ffffff,#e0e0e0
قسم العمولات,توزيع المستحقات,#fff3e0,#ff6f00
نسبة المورد,العمولة المتفق عليها,#ffffff,#e0e0e0
مستحق المورد,المبلغ بالريال,#e8f5e9,#66bb6a
صافي ربح الشركة,المبلغ بالريال,#c8e6c9,#388e3c
الملخص المالي النهائي,الحسابات الختامية,#f3e5f5,#7b1fa2
المبلغ الإجمالي,قبل الخصومات,#ffffff,#e0e0e0
إجمالي الخصومات,المبلغ المخصوم,#ffcdd2,#e57373
المبلغ بعد الخصم,بعد تطبيق الخصومات,#ffffff,#e0e0e0
ضريبة القيمة المضافة,15%,#ffffff,#e0e0e0
المبلغ النهائي,للتأكيد,#ffecb3,#ff6f00
ملاحظات الإقفال,حقل نصي اختياري,#fafafa,#bdbdbd
أزرار الإجراء,إقفال نهائي أو إلغاء,#f5f5f5,#cccccc
زر إقفال نهائي,لا يمكن التراجع,#f44336,#c62828
زر حفظ كمسودة,للمراجعة لاحقاً,#2196f3,#1565c0
زر إلغاء,إغلاق دون حفظ,#9e9e9e,#757575
```
...
Section,Component,fill,stroke
الرأس,عنوان + عداد + زر إضافة,#ffffff,#e0e0e0
الفلاتر,منطقة + فئة + مورد + حالة + بحث,#fafafa,#bdbdbd
الجدول,قائمة السيارات,#ffffff,#e0e0e0
عمود الصورة,صورة مصغرة,#f5f5f5,#cccccc
عمود اللوحة,رقم + أيقونة,#e3f2fd,#1976d2
عمود السيارة,ماركة + موديل + سنة,#ffffff,#e0e0e0
عمود الفئة,نوع مع أيقونة,#fff3e0,#ff6f00
عمود المورد,اسم + جوال,#e8f5e9,#66bb6a
عمود الحالة,مفتاح تبديل,#ffffff,#e0e0e0
عمود الإحصائيات,عدد الرحلات + التقييم,#f3e5f5,#7b1fa2
عمود الإجراءات,أزرار متعددة,#e0e0e0,#9e9e9e
نافذة تفاصيل السيارة,Modal شامل,#ffffff,#e0e0e0
معلومات أساسية,جميع البيانات,#e3f2fd,#1976d2
المستندات,استمارة + تأمين,#fff8e1,#ffa000
الصور,8 صور,#f5f5f5,#cccccc
سجل الصيانة,تواريخ + ملاحظات,#fff3e0,#ff6f00
سجل الحجوزات,آخر الرحلات,#e8f5e9,#66bb6a
```
...
Column,Content,fill,stroke
الاسم,نص + صورة دائرية,#e3f2fd,#1976d2
الجوال,رقم + زر اتصال,#ffffff,#e0e0e0
السيارات,عدد + رابط,#fff3e0,#ff6f00
العمولة,نسبة مئوية قابلة للتعديل,#fff8e1,#ffa000
الرحلات,عدد إجمالي,#e8f5e9,#66bb6a
التقييم,نجوم + رقم,#fff9c4,#f9a825
الرصيد,مبلغ بالريال,#f3e5f5,#7b1fa2
آخر رحلة,تاريخ,#ffffff,#e0e0e0
الحالة,متاح أو إجازة,#e0f2f1,#00897b
الإجراءات,أزرار متعددة,#e0e0e0,#9e9e9e
```
...
Element,Specification,fill,stroke
الشعار,رحلتي VIP + أيقونة سيارة,#FF8C00,#E67E00
اللون الأساسي,#FF8C00 برتقالي ذهبي,#FF8C00,#E67E00
اللون الثانوي,#333333 رمادي داكن,#333333,#000000
الخط العربي,Cairo - Google Fonts,#ffffff,#e0e0e0
الخط الإنجليزي,Roboto - Google Fonts,#ffffff,#e0e0e0
الأيقونات,Material Icons Rounded,#e3f2fd,#1976d2
العناوين الكبرى,32px Bold,#fff8e1,#ffa000
العناوين الفرعية,24px Semi-bold,#fff8e1,#ffa000
النصوص الأساسية,16px Regular,#ffffff,#e0e0e0
النصوص الثانوية,14px Regular,#f5f5f5,#bdbdbd
الأزرار الأساسية,برتقالي + أبيض + مدور,#FF8C00,#E67E00
الأزرار الثانوية,إطار رمادي + خلفية بيضاء,#ffffff,#9e9e9e
البطاقات,أبيض + ظل ناعم + حواف مدورة,#ffffff,#e0e0e0
الجداول,صفوف متناوبة + ترويسة رمادية,#fafafa,#bdbdbd
النماذج,إطار رفيع + تركيز برتقالي,#ffffff,#e0e0e0
رسائل النجاح,خلفية خضراء فاتحة + أيقونة ✓,#e8f5e9,#4CAF50
رسائل الخطأ,خلفية حمراء فاتحة + أيقونة ✗,#ffebee,#F44336
رسائل التحذير,خلفية صفراء فاتحة + أيقونة ⚠,#fff9c4,#FFC107
رسائل المعلومات,خلفية زرقاء فاتحة + أيقونة ℹ,#e3f2fd,#2196F3
```
